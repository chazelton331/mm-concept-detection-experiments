...
public class SpatialPyramids {
	...
	public static double[] pyramids(String filename, String codebookFileName) throws Exception{
	 ...
	 public static void prepareVLADPyramidsFeatures(String idListFile, String directory, String projectionFile, String codebookFileName, String outputFeatureFile) throws Exception {
		...
		public static void main(String[] args) throws Exception {	 
	    	...
	    	try {
	    		prepareVLADPyramidsFeatures(idListFile, directory,projectionFile, codebookFileName, outputFile);	    		
		    } catch (IOException e){
		    	e.printStackTrace();
		    }
		}	
